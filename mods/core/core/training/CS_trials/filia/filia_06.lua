...
-- Ringlet Spike H (236HP)
-- Gregor (214KK)
-- dash 5HP
-- jHK air dash cancel
-- jLK jMP jHK
-- 2MP
-- jMK (2 hits) air dash cancel
-- jLP jMP jHK
...
Combo = {
  ...
  did10 = false,
  {
    text = "CS_Filia1Trial6_pt1",  -- Ringlet Spike H (Any)
  ...
  {
    text = "CS_Filia1Trial6_pt2",  -- Gregor (214KK)
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      ...
      while not success do
        ...
        if p1:hasTag("Roach") and p1.numhits > 0 and p2:hasTag("Hitstun") then
          hitwithGregor = true
        end

        if hitwithGregor and did1 then
          success = true
          wedidit = true
          break
        end
  ...
  {
    text = "CS_Filia1Trial6_pt4",  --- jHK air dash cancel
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      local p1, p2 = getP1(), getP2()
      ...
      while not success do
        ...
        if hitwithJHK and DoAirDash and did3 then
          success = true
          wedidit = true
          break
        end
  ...
  {
    text = "CS_Filia1Trial6_pt5",  -- jLK jMP jHK
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      local p1, p2 = getP1(), getP2()
      ...
      while not success do
        ...
        if hitwithJLK and hitwithJMP and hitwithJHK and did4 then
          success = true
          wedidit = true
          break
        end
  ...
  {
    text = "CS_Filia1Trial6_pt7",  -- jMK (2 hits) air dash cancel
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      local p1, p2 = getP1(), getP2()
      ...
      while not success do
        ...
        if hitwithJMK and DoAirDash and did6 then
          success = true
          wedidit = true
          break
        end
  ...
  {
    text = "CS_Filia1Trial6_pt8",  -- jLP jMP jHK
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      local p1, p2 = getP1(), getP2()
      ...
      while not success do
        ...
        if hitwithJLP and hitwithJMP and hitwithJHK and did7 then
          success = true
          wedidit = true
          break
        end
  ...
  {
    text = "CS_Filia1Trial6_pt9",  -- 5LP 5LP 5LK 5MP 2MK 2HP 
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      local p1, p2 = getP1(), getP2()
      ...
      while not success do
        ...
        if hitwithSLP and hitwithSLK and hitwithSMP and hitwithCMK and hitwithCHP and did8 then
          success = true
          wedidit = true
          break
        end
  ...
  {
    text = "CS_Filia1Trial6_pt10",  -- hairballH(214HK) Fenrir(623PP)
    --details = "DoTheCombo_Cmd",
    func = function(helpers)
      local p1, p2 = getP1(), getP2()
